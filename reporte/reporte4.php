...
{//RECTANGULO grande
    ...
    $this->Cell(120,80,utf8_decode('Estudiantes que no pertenecen a un grupo'),0,0,'C');
    ...
    //color de la lineas
     ...
     $this->Cell(30,10,'CODIGO',0,0,'C',1);
     $this->Cell(100,10,'ESTUDIANTE',0,0,'C',1);
     $this->Cell(50,10,'ESCUELA',0,1,'C',1);
 

    //para la linea
    $this->SetDrawColor(44, 189, 176);
    $this->SetLineWidth(1);
    $this->Line(10,82,190,82);
    $this->Ln(5);
}
...
$cont=1;
      ...
      $sql = $conexion -> query("SELECT idAlumno, p.idPersona, codigo_alumno, dni,concat(apellido,' ',nombre) ALUMNO, genero, direccion, email, telefono,f.idFacultad, nombre_facultad, e.idEscuela, nombre_escuela
      ...
      where idAlumno not in (select idAlumno from alumnogrupo);");
