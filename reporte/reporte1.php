...
$sql = $db->query("SELECT f.nombre_facultad,e.nombre_escuela, COUNT(*) cantidad
      ...
      group by e.nombre_escuela,f.nombre_facultad ;");
...
while ($empleados = $sql->fetch_assoc()) {
    ...
    //cargado de datos
    $pdf->Cell(80, 10, $empleados['nombre_facultad'], 1, 0, 'J', 1);
    $pdf->Cell(80, 10, $empleados['nombre_escuela'], 1, 0, 'C', 1);
